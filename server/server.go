...
import (
	...
	"github.com/uhhc/rancher/pkg/api/customization/vsphere"
	managementapi "github.com/uhhc/rancher/pkg/api/server"
	"github.com/uhhc/rancher/pkg/audit"
	"github.com/uhhc/rancher/pkg/auth/providers/publicapi"
	"github.com/uhhc/rancher/pkg/auth/providers/saml"
	"github.com/uhhc/rancher/pkg/auth/requests"
	"github.com/uhhc/rancher/pkg/auth/requests/sar"
	"github.com/uhhc/rancher/pkg/auth/tokens"
	webhook2 "github.com/uhhc/rancher/pkg/auth/webhook"
	"github.com/uhhc/rancher/pkg/channelserver"
	"github.com/uhhc/rancher/pkg/clustermanager"
	rancherdialer "github.com/uhhc/rancher/pkg/dialer"
	"github.com/uhhc/rancher/pkg/httpproxy"
	k8sProxyPkg "github.com/uhhc/rancher/pkg/k8sproxy"
	"github.com/uhhc/rancher/pkg/metrics"
	"github.com/uhhc/rancher/pkg/pipeline/hooks"
	"github.com/uhhc/rancher/pkg/rkenodeconfigserver"
	"github.com/uhhc/rancher/pkg/telemetry"
	"github.com/uhhc/rancher/pkg/websocket"
	"github.com/uhhc/rancher/server/capabilities"
	"github.com/uhhc/rancher/server/ui"
