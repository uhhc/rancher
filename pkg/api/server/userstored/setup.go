...
import (
	...
	namespacecustom "github.com/uhhc/rancher/pkg/api/customization/namespace"
	"github.com/uhhc/rancher/pkg/api/customization/persistentvolumeclaim"
	sec "github.com/uhhc/rancher/pkg/api/customization/secret"
	"github.com/uhhc/rancher/pkg/api/customization/yaml"
	"github.com/uhhc/rancher/pkg/api/store/apiservice"
	"github.com/uhhc/rancher/pkg/api/store/cert"
	"github.com/uhhc/rancher/pkg/api/store/crd"
	"github.com/uhhc/rancher/pkg/api/store/hpa"
	"github.com/uhhc/rancher/pkg/api/store/ingress"
	"github.com/uhhc/rancher/pkg/api/store/namespace"
	"github.com/uhhc/rancher/pkg/api/store/nocondition"
	"github.com/uhhc/rancher/pkg/api/store/pod"
	"github.com/uhhc/rancher/pkg/api/store/projectsetter"
	"github.com/uhhc/rancher/pkg/api/store/secret"
	"github.com/uhhc/rancher/pkg/api/store/service"
	"github.com/uhhc/rancher/pkg/api/store/storageclass"
