...
import (
	...
	"github.com/uhhc/rancher/pkg/api/controllers/catalog"
	"github.com/uhhc/rancher/pkg/api/controllers/dynamicschema"
	"github.com/uhhc/rancher/pkg/api/controllers/feature"
	"github.com/uhhc/rancher/pkg/api/controllers/k3smetadata"
	"github.com/uhhc/rancher/pkg/api/controllers/samlconfig"
	"github.com/uhhc/rancher/pkg/api/controllers/settings"
	"github.com/uhhc/rancher/pkg/api/controllers/usercontrollers"
	whitelistproxyKontainerDriver "github.com/uhhc/rancher/pkg/api/controllers/whitelistproxy/kontainerdriver"
	whitelistproxyNodeDriver "github.com/uhhc/rancher/pkg/api/controllers/whitelistproxy/nodedriver"
	"github.com/uhhc/rancher/pkg/api/server/managementstored"
	"github.com/uhhc/rancher/pkg/api/server/userstored"
