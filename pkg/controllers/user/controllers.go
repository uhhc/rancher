...
import (
	...
	"github.com/uhhc/rancher/pkg/controllers/user/alert"
	"github.com/uhhc/rancher/pkg/controllers/user/approuter"
	"github.com/uhhc/rancher/pkg/controllers/user/certsexpiration"
	"github.com/uhhc/rancher/pkg/controllers/user/cis"
	"github.com/uhhc/rancher/pkg/controllers/user/clusterauthtoken"
	"github.com/uhhc/rancher/pkg/controllers/user/dnsrecord"
	"github.com/uhhc/rancher/pkg/controllers/user/endpoints"
	"github.com/uhhc/rancher/pkg/controllers/user/externalservice"
	"github.com/uhhc/rancher/pkg/controllers/user/globaldns"
	"github.com/uhhc/rancher/pkg/controllers/user/healthsyncer"
	"github.com/uhhc/rancher/pkg/controllers/user/helm"
	"github.com/uhhc/rancher/pkg/controllers/user/ingress"
	"github.com/uhhc/rancher/pkg/controllers/user/ingresshostgen"
	"github.com/uhhc/rancher/pkg/controllers/user/istio"
	"github.com/uhhc/rancher/pkg/controllers/user/logging"
	"github.com/uhhc/rancher/pkg/controllers/user/monitoring"
	"github.com/uhhc/rancher/pkg/controllers/user/networkpolicy"
	"github.com/uhhc/rancher/pkg/controllers/user/noderemove"
	"github.com/uhhc/rancher/pkg/controllers/user/nodesyncer"
	"github.com/uhhc/rancher/pkg/controllers/user/nslabels"
	"github.com/uhhc/rancher/pkg/controllers/user/nsserviceaccount"
	"github.com/uhhc/rancher/pkg/controllers/user/pipeline"
	"github.com/uhhc/rancher/pkg/controllers/user/rbac"
	"github.com/uhhc/rancher/pkg/controllers/user/rbac/podsecuritypolicy"
	"github.com/uhhc/rancher/pkg/controllers/user/resourcequota"
	"github.com/uhhc/rancher/pkg/controllers/user/secret"
	"github.com/uhhc/rancher/pkg/controllers/user/servicemonitor"
	"github.com/uhhc/rancher/pkg/controllers/user/systemimage"
	"github.com/uhhc/rancher/pkg/controllers/user/targetworkloadservice"
	"github.com/uhhc/rancher/pkg/controllers/user/windows"
	"github.com/uhhc/rancher/pkg/controllers/user/workload"
	pkgmonitoring "github.com/uhhc/rancher/pkg/monitoring"
